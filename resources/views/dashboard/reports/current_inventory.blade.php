        ...
        <div class="container">
            ...
            <div class="table-responsive">
                <table class="blueTable">
                    ...
                    <tbody>
                        @foreach ($medicines as $medicine)
                            <tr>
                                ...
                                <th>{{ $medicine->name }}</th>
                                <th>{{ Carbon\Carbon::parse($medicine->expiry_date)->format('Y-m-d') }}</th>
                                <th>{{ $medicine->unit_price }}</th>
                                <th>{{ $medicine->price }}</th>
                                <th>{{ $medicine->supplier->name }}</th>
                    ...
                    <tfoot>
                        <tr>
                            <th colspan="6" class="text-center">المجموع</th>
                            <th>{{ $medicines->sum('quantity') }}</th>
                        </tr>
                    </tfoot>
                </table>
            </div>     
