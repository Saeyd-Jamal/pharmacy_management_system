...
<div class="row">
        ...
        <div class="card">
            ...
            <div class="d-flex flex-wrap flex-column flex-sm-row justify-content-between text-heading">
                ...
                <div class="d-flex svg-illustration mb-6 gap-2 align-items-center">
                    ...
                    <span class="app-brand-text fw-bold fs-4 ms-50">{{ isset($btn_label) ? 'تعديل فاتورة بيع': 'إضافة فاتورة بيع جديدة' }}</span>
                </div>
                </div>
                    ...
                    <dl class="row mb-0">
                        ...
                        <dd class="col-sm-7">
                            <div class="input-group input-group-merge disabled">
                                ...
                                <x-form.input name="invoice_id" :value="$saleInvoice->id"  disabled />
                            </div>
                        </dd>
                        <dt class="col-sm-5 mb-2 d-md-flex align-items-center justify-content-end">
                        ...
                        <dd class="col-sm-7">
                            <x-form.input class="invoice-date flatpickr-input" type="date" placeholder="YYYY-MM-DD" :value="$saleInvoice->date" name="date" required />
                        </dd>
                    </dl>
                </div>
            </div>
            ...
            <div class="card-body pt-4">
                ...
                <div class="row">
                    @foreach ($saleInvoice->medicines as $index => $item)
                ...
                <input type="hidden" name="item_count" id="item_count" value="{{ $saleInvoice->medicines->count() }}">
    ...
    <div class="col-md-3">
        <div class="card mb-4">
            <div class="card-body">
                <div class="mb-4">
                    <x-form.input label="الزبون" :value="$saleInvoice->customer_name" name="customer_name" placeholder="زبون عام" list="customer_names" />
                ...
                <div class="mb-4">
                    <x-form.input type="number" min="0" label="الإجمالي" :value="$saleInvoice->total_amount" name="total_amount" readonly/>
                </div>
            </div>
        </div>
        <div class="card">
